...
<head>
    ...
    <title>Gestion des Employés - Port de La Rochelle</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .badge-autre {
            background: linear-gradient(135deg, rgba(149, 165, 166, 0.4) 0%, rgba(127, 140, 141, 0.4) 100%);
            color: #bdc3c7;
    ...
    <div class="container">
        <div class="header">
            <div class="header-title">
                ...
                <h1>Employés du Port</h1>
            </div>
            <div class="action-buttons">
                <a href="index.php?page=ajouterEmploye" class="btn btn-primary">
                    ➕ Ajouter un employé
                </a>
        ...
        <?php if (!empty($message)): ?>
            <div class="message <?= strpos($message, 'succès') !== false ? 'success' : 'error' ?>">
                <?= strpos($message, 'succès') !== false ? '✓' : '✗' ?> <?= htmlspecialchars($message) ?>
            </div>
        <?php endif; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($role === 'docker') {
                                        ...
                                        $badgeClass = 'badge-pilote';
                                        $icon = '🧭';
                                    }
                                    ?>
                                    <span class="badge <?= $badgeClass ?>">
                                        <?= $icon ?> <?= htmlspecialchars($emp['role']) ?>
                                    </span>
                                </td>
                                <td>
                                    <div class="action-cell">
                                        <a href="index.php?page=modifierEmploye&id=<?= $emp['id_employee'] ?>" 
                                           class="btn-small btn-warning" 
                                           title="Modifier">
                                            ✏️ Modifier
                                        </a>
                                        <a href="index.php?page=supprimerEmploye&id=<?= $emp['id_employee'] ?>" 
