...
<head>
    ...
    <title>Modifier un navire - Port de La Rochelle</title>
    <style>
    ...
    <div class="container">
        <div class="header">
            <div class="header-title">
                ...
                <h1>Modifier : <?= htmlspecialchars($navire['nom']) ?></h1>
            </div>
        ...
        <div class="form-card">
            <form method="POST" action="index.php?page=navire_modifier&id_navire=<?= $navire['id_navire'] ?>">
                ...
                <div class="form-actions">
                    ...
                    <a href="index.php?page=navire_details&id_navire=<?= $navire['id_navire'] ?>" class="btn btn-secondary">✕ Annuler</a>
                    <a href="index.php?page=navires" class="btn btn-secondary">← Liste</a>
                </div>
            </form>
        </div>
    </div>
